        ...
        <div className="inline-block max-w-lg text-center justify-center">
          ...
          <Card className="bg-primary/30 backdrop-blur-md mt-10">
            ...
            <Card.Content>
              ...
              <p>I am 11 years old and I started this business because I love animals. I have one bunny, three gerbils, three cats, and five chickens. I enjoy hanging out with dogs (Even if it means getting soaked!) I am currently being trained by a professional groomer, so my skills are always improving. Whether a tiny chihuahua or a Great Pyrenees, your dog will be showered in affection and comfort! I hope you will consider me as your dog groomer. If you want to schedule a booking, take a look at my schedule and figure out the time that works best for you. If you have any questions, fill out the contact form and we'll get back to you.
                Thank you! </p>
            </Card.Content>
